...
export function FaqTransfer() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Terdapat 2 jenis metode transfer di wondr, khusus untuk kamu yang ingin transfer ke bank selain BNI: BI-FAST Tersedia 24 jam Biaya transaksi: Rp2.500 Realtime Online Tersedia 24 jam Biaya transaksi: Rp6.500"
    }
  ];
